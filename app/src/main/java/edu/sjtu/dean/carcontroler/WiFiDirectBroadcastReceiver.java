    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (WifiP2pManager.WIFI_P2P_STATE_CHANGED_ACTION.equals(action)) {
            ...
            if (networkInfo.isConnected()) {
                ...
                activity.setIsWifiP2pConnected(true);
                ListDetailFragment fragment = (ListDetailFragment) activity
                        .getFragmentManager().findFragmentById(R.id.frag_detail);
                manager.requestConnectionInfo(channel, fragment);

            }  else {
                // It's a disconnect
                activity.setIsWifiP2pConnected(false);
                activity.resetData();
                ListDetailFragment fragment = (ListDetailFragment) activity
                        .getFragmentManager().findFragmentById(R.id.frag_detail);
                fragment.resetViews();
            ...
            MainActivityFragment fragment = (MainActivityFragment) activity.getFragmentManager()
                    .findFragmentById(R.id.frag_list);
